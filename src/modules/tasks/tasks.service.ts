...
export class TasksService {
    ...
    async synchronizePools() {
        ...
        const latestPoolTimestamp = await this.poolsService.getLatestPoolTimestamp();
        ...
        const poolsDetails = await this.poolsApiService.getPoolsDetails(latestPoolTimestamp);
